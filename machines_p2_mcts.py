...
class Node:
    ...
    def uct_value(self, exploration_weight=2.3):
        """
...
def mcts(initial_state, simulation_count=20000, max_depth=10):
    """
    MCTS 알고리즘 구현
    """
